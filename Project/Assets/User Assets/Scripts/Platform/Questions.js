...
var inLevel1_room1 : boolean = false;
var inLevel1_room2 : boolean = false;
var inLevel1_room3 : boolean = false;
var inLevel1_room4 : boolean = false;
var inLevel1_room5 : boolean = false;

var inLevel2_room1 : boolean = false;
var inLevel2_room2 : boolean = false;
var inLevel2_room3 : boolean = false;
var inLevel2_room4 : boolean = false;
var inLevel2_room5 : boolean = false;
 
var inLevel3_room1 : boolean = false;
var inLevel3_room2 : boolean = false;
var inLevel3_room3 : boolean = false;
var inLevel3_room4 : boolean = false;
var inLevel3_room5 : boolean = false;

var Level1_room1 : GameObject;
var Level1_room2 : GameObject;
var Level1_room3 : GameObject;
var Level1_room4 : GameObject;
var Level1_room5 : GameObject;

var Level2_room1 : GameObject;
var Level2_room2 : GameObject;
var Level2_room3 : GameObject;
var Level2_room4 : GameObject;
var Level2_room5 : GameObject;

var Level3_room1 : GameObject;
var Level3_room2 : GameObject;
var Level3_room3 : GameObject;
var Level3_room4 : GameObject;
var Level3_room5 : GameObject;
...
var eenScore: boolean = false;	
var answerCount : int = 0;
	
var targetPosition_level1_room1 : Transform;
var targetPosition_level1_room2 : Transform;
var targetPosition_level1_room3 : Transform;
var targetPosition_level1_room4 : Transform;
var targetPosition_level1_room5 : Transform;

var targetPosition_level2_room1 : Transform;
var targetPosition_level2_room2 : Transform;
var targetPosition_level2_room3 : Transform;
var targetPosition_level2_room4 : Transform;
var targetPosition_level2_room5 : Transform;

var targetPosition_level3_room1 : Transform;
var targetPosition_level3_room2 : Transform;
var targetPosition_level3_room3 : Transform;
var targetPosition_level3_room4 : Transform;
var targetPosition_level3_room5 : Transform;

var false_level1_room1 : GameObject[];
var false_level1_room2 : GameObject[];
var false_level1_room3 : GameObject[];
var false_level1_room4 : GameObject[];
var false_level1_room5 : GameObject[];

var false_level2_room1 : GameObject[];
var false_level2_room2 : GameObject[];
var false_level2_room3 : GameObject[];
var false_level2_room4 : GameObject[];
var false_level2_room5 : GameObject[];

var false_level3_room1 : GameObject[];
var false_level3_room2 : GameObject[];
var false_level3_room3 : GameObject[];
var false_level3_room4 : GameObject[];
var false_level3_room5 : GameObject[];

var inventory : Inventory_GUI;
inventory = FindObjectOfType(Inventory_GUI);

var shakeScript : CameraShake;
shakeScript = FindObjectOfType(CameraShake);

var textContainer10 : GameObject;
var textContainer5 : GameObject;
var textContainer1 : GameObject;

var VentralDorsalPancreas : GameObject;
var VitellineDuct : GameObject;
var RespiratoryBud : GameObject;
var ThyroidGland : GameObject;
var Liver : GameObject;

var Coelom : GameObject;
var Heart : GameObject;
var Veins : GameObject;
var Somites : GameObject;
var UrogenitalRidge : GameObject;

var LensPlacodeOpticVesticle : GameObject;
var OticVesicle : GameObject;
var Neuraltube : GameObject;
var Skin: GameObject;
var RathkesPouch : GameObject;
...
var InfoButtonPosition : Vector2 = new Vector2(382,25);
var InfoButtonSize : Vector2 = new Vector2(40,40);
var InfoTextPosition : Vector2 = new Vector2(345,143);
...
function OnGUI(){
	...
	if(inLevel1_room3 == true){
		GUILayout.BeginArea (Rect (Screen.width * 0.4, Screen.height - Screen.height + 50, TextSize.x,TextSize.y));  
		var RespiratoryBudVraag = "<i>Press the information button if you don't know the answer.</i>\n\nQuestion:\nThe respiratory bud develops from the…\n\nAnswers:\nA: Oral cavity\nB: Vitelline duct\nC: Duodenum\nD: Midgut\nE: Foregut\n\nChoose the correct hallway to answer the question.";
	    if(GUI.Button(Rect(InfoButtonPosition.x, InfoButtonPosition.y, InfoButtonSize.x, InfoButtonSize.y), InfoIcon))
        	{
        		if(InfoClicked == false){
        			InfoClicked = true;
...
function OnTriggerEnter(other: Collider){
	...
	audio.PlayOneShot(correctAnswerSound);
		if(answerCount == 0){
			...
			for (var false_l1_r1_1 : GameObject in false_level1_room1){
		 ...
		 if(answerCount == 1){
			...
			Destroy(other.gameObject);
		Destroy(GameObject.FindGameObjectWithTag("Level1_room1"));
		for (var false_l1_r1_2 : GameObject in false_level1_room1){
			...
			Destroy(other.gameObject);
		Destroy(GameObject.FindGameObjectWithTag("Level1_room1"));
		for (var false_l1_r1_3 : GameObject in false_level1_room1){
	...
	if(other.gameObject.tag == "false_level1_room1"){
		...
		fade.alpha = 1.0;
		mainCamera.transform.position.x = targetPosition_level1_room1.position.x;
		...
		var teleportParlvl1r1 : GameObject = Instantiate(teleportParticle, this.gameObject.transform.position, Quaternion.Euler(0,0,0));
		teleportParlvl1r1.gameObject.transform.parent = this.gameObject.transform;
		teleportParlvl1r1.transform.position.y -= 10;
		shakeScript.Shake();
	}
	...
	audio.PlayOneShot(correctAnswerSound);
		if(answerCount == 0){
			...
			for (var false_l1_r2_1 : GameObject in false_level1_room2){
		...
		if(answerCount == 1){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level1_room2"));
			for (var false_l1_r2_2 : GameObject in false_level1_room2){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level1_room2"));
			for (var false_l1_r2_3 : GameObject in false_level1_room2){
	...
	if(other.gameObject.tag == "false_level1_room2"){
		...
		fade.boolfadeIn = true;
		fade.alpha = 1.0;
		mainCamera.transform.position.x = targetPosition_level1_room2.position.x;
		...
		var teleportParlvl1r2 : GameObject = Instantiate(teleportParticle, this.gameObject.transform.position, Quaternion.Euler(0,0,0));
		teleportParlvl1r2.gameObject.transform.parent = this.gameObject.transform;
		teleportParlvl1r2.transform.position.y -= 10;
		shakeScript.Shake();
	}
	...
	if(other.gameObject.tag == "correct_level1_room3"){
		...
		if(answerCount == 0){
			...
			for (var false_l1_r3_1 : GameObject in false_level1_room3){
		...
		if(answerCount == 1){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level1_room3"));
			for (var false_l1_r3_2 : GameObject in false_level1_room3){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level1_room3"));
			for (var false_l1_r3_3 : GameObject in false_level1_room3){
	...
	if(other.gameObject.tag == "false_level1_room3"){
		...
		fade.boolfadeIn = true;
		fade.alpha = 1.0;
		mainCamera.transform.position.x = targetPosition_level1_room3.position.x;
		...
		var teleportParlvl1r3 : GameObject = Instantiate(teleportParticle, this.gameObject.transform.position, Quaternion.Euler(0,0,0));
		teleportParlvl1r3.gameObject.transform.parent = this.gameObject.transform;
		teleportParlvl1r3.transform.position.y -= 10;
		shakeScript.Shake();
	}
	...
	audio.PlayOneShot(correctAnswerSound);
		if(answerCount == 0){
			...
			for (var false_l1_r4_1 : GameObject in false_level1_room4){
		...
		if(answerCount == 1){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level1_room4"));
			for (var false_l1_r4_2 : GameObject in false_level1_room4){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level1_room4"));
			for (var false_l1_r4_3 : GameObject in false_level1_room4){
	...
	if(other.gameObject.tag == "false_level1_room4"){
		...
		fade.boolfadeIn = true;
		fade.alpha = 1.0;
		mainCamera.transform.position.x = targetPosition_level1_room4.position.x;
		...
		var teleportParlvl1r4 : GameObject = Instantiate(teleportParticle, this.gameObject.transform.position, Quaternion.Euler(0,0,0));
		teleportParlvl1r4.gameObject.transform.parent = this.gameObject.transform;
		teleportParlvl1r4.transform.position.y -= 10;
		shakeScript.Shake();
	}
	...
	if(other.gameObject.tag == "correct_level1_room5"){
		...
		if(answerCount == 0){
			...
			for (var false_l1_r5_1 : GameObject in false_level1_room5){
		...
		if(answerCount == 1){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level1_room5"));
			for (var false_l1_r5_2 : GameObject in false_level1_room5){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level1_room5"));
			for (var false_l1_r5_3 : GameObject in false_level1_room5){
	...
	if(other.gameObject.tag == "false_level1_room5"){
		...
		fade.boolfadeIn = true;
		fade.alpha = 1.0;
		mainCamera.transform.position.x = targetPosition_level1_room5.position.x;
		...
		var teleportParlvl1r5 : GameObject = Instantiate(teleportParticle, this.gameObject.transform.position, Quaternion.Euler(0,0,0));
		teleportParlvl1r5.gameObject.transform.parent = this.gameObject.transform;
		teleportParlvl1r5.transform.position.y -= 10;
		shakeScript.Shake();
	}
	...
	if(other.gameObject.tag == "correct_level2_room1"){
		...
		if(answerCount == 0){
			...
			for (var false_l2_r1_1 : GameObject in false_level2_room1){
		...
		if(answerCount == 1){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level2_room1"));
			for (var false_l2_r1_2 : GameObject in false_level2_room1){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level2_room1"));
			for (var false_l2_r1_3 : GameObject in false_level2_room1){
	...
	if(other.gameObject.tag == "false_level2_room1"){
		...
		fade.boolfadeIn = true;
		fade.alpha = 1.0;
		mainCamera.transform.position.x = targetPosition_level2_room1.position.x;
		...
		var teleportParlvl2r1 : GameObject = Instantiate(teleportParticle, this.gameObject.transform.position, Quaternion.Euler(0,0,0));
		teleportParlvl2r1.gameObject.transform.parent = this.gameObject.transform;
		teleportParlvl2r1.transform.position.y -= 10;
		shakeScript.Shake();
	}
	...
	if(other.gameObject.tag == "correct_level2_room2"){
		...
		if(answerCount == 0){
			...
			for (var false_l2_r2_1 : GameObject in false_level2_room2){
		...
		if(answerCount == 1){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level2_room2"));
			for (var false_l2_r2_2 : GameObject in false_level2_room2){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level2_room2"));
			for (var false_l2_r2_3 : GameObject in false_level2_room2){
		...
		fade.boolfadeIn = true;
		fade.alpha = 1.0;
		mainCamera.transform.position.x = targetPosition_level2_room2.position.x;
		...
		var teleportParlvl2r2 : GameObject = Instantiate(teleportParticle, this.gameObject.transform.position, Quaternion.Euler(0,0,0));
		teleportParlvl2r2.gameObject.transform.parent = this.gameObject.transform;
		teleportParlvl2r2.transform.position.y -= 10;
		shakeScript.Shake();
	}
	...
	if(other.gameObject.tag == "correct_level2_room3"){
		...
		if(answerCount == 0){
			...
			for (var false_l2_r3_1 : GameObject in false_level2_room3){
		...
		if(answerCount == 1){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level2_room3"));
			for (var false_l2_r3_2 : GameObject in false_level2_room3){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level2_room3"));
			for (var false_l2_r3_3 : GameObject in false_level2_room3){
	...
	if(other.gameObject.tag == "false_level2_room3"){
		...
		fade.boolfadeIn = true;
		fade.alpha = 1.0;
		mainCamera.transform.position.x = targetPosition_level2_room3.position.x;
		...
		var teleportParlvl2r3 : GameObject = Instantiate(teleportParticle, this.gameObject.transform.position, Quaternion.Euler(0,0,0));
		teleportParlvl2r3.gameObject.transform.parent = this.gameObject.transform;
		teleportParlvl2r3.transform.position.y -= 10;
		shakeScript.Shake();
	}
	...
	if(other.gameObject.tag == "correct_level2_room4"){
		...
		if(answerCount == 0){
			...
			for (var false_l2_r4_1 : GameObject in false_level2_room4){
		...
		if(answerCount == 1){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level2_room4"));
			for (var false_l2_r4_2 : GameObject in false_level2_room4){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level2_room4"));
			for (var false_l2_r4_3 : GameObject in false_level2_room4){
	...
	if(other.gameObject.tag == "false_level2_room4"){
		...
		fade.boolfadeIn = true;
		fade.alpha = 1.0;
		mainCamera.transform.position.x = targetPosition_level2_room4.position.x;
		...
		var teleportParlvl2r4 : GameObject = Instantiate(teleportParticle, this.gameObject.transform.position, Quaternion.Euler(0,0,0));
		teleportParlvl2r4.gameObject.transform.parent = this.gameObject.transform;
		teleportParlvl2r4.transform.position.y -= 10;
		shakeScript.Shake();
	}
	...
	if(other.gameObject.tag == "correct_level2_room5"){
		...
		if(answerCount == 0){
			...
			for (var false_l2_r5_1 : GameObject in false_level2_room5){
		...
		if(answerCount == 1){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level2_room5"));
			for (var false_l2_r5_2 : GameObject in false_level2_room5){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level2_room5"));
			for (var false_l2_r5_3 : GameObject in false_level2_room5){
	...
	if(other.gameObject.tag == "false_level2_room5"){
		...
		fade.boolfadeIn = true;
		fade.alpha = 1.0;
		mainCamera.transform.position.x = targetPosition_level2_room5.position.x;
		...
		var teleportParlvl2r5 : GameObject = Instantiate(teleportParticle, this.gameObject.transform.position, Quaternion.Euler(0,0,0));
		teleportParlvl2r5.gameObject.transform.parent = this.gameObject.transform;
		teleportParlvl2r5.transform.position.y -= 10;
		shakeScript.Shake();
	}
	...
	if(other.gameObject.tag == "correct_level3_room1"){
		...
		if(answerCount == 0){
			...
			for (var false_l3_r1_1 : GameObject in false_level3_room1){
		...
		if(answerCount == 1){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level3_room1"));
			for (var false_l3_r1_2 : GameObject in false_level3_room1){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level3_room1"));
			for (var false_l3_r1_3 : GameObject in false_level3_room1){
	...
	if(other.gameObject.tag == "false_level3_room1"){
		...
		fade.boolfadeIn = true;
		fade.alpha = 1.0;
		mainCamera.transform.position.x = targetPosition_level3_room1.position.x;
		...
		var teleportParlvl3r1 : GameObject = Instantiate(teleportParticle, this.gameObject.transform.position, Quaternion.Euler(0,0,0));
		teleportParlvl3r1.gameObject.transform.parent = this.gameObject.transform;
		teleportParlvl3r1.transform.position.y -= 10;
		shakeScript.Shake();
	}
	...
	if(other.gameObject.tag == "correct_level3_room2"){
		...
		if(answerCount == 0){
			...
			for (var false_l3_r2_1 : GameObject in false_level3_room2){
		...
		if(answerCount == 1){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level3_room2"));
			for (var false_l3_r2_2 : GameObject in false_level3_room2){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level3_room2"));
			for (var false_l3_r2_3 : GameObject in false_level3_room2){
	...
	if(other.gameObject.tag == "false_level3_room2"){
		...
		fade.boolfadeIn = true;
		fade.alpha = 1.0;
		mainCamera.transform.position.x = targetPosition_level3_room2.position.x;
		...
		var teleportParlvl3r2 : GameObject = Instantiate(teleportParticle, this.gameObject.transform.position, Quaternion.Euler(0,0,0));
		teleportParlvl3r2.gameObject.transform.parent = this.gameObject.transform;
		teleportParlvl3r2.transform.position.y -= 10;
		shakeScript.Shake();
	}
	if(other.gameObject.tag == "Level3_room3"){
		...
		if(answerCount == 0){
			...
			for (var false_l3_r3_1 : GameObject in false_level3_room3){
		...
		if(answerCount == 1){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level3_room3"));
			for (var false_l3_r3_2 : GameObject in false_level3_room3){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level3_room3"));
			for (var false_l3_r3_3 : GameObject in false_level3_room3){
	...
	if(other.gameObject.tag == "false_level3_room3"){
		...
		fade.boolfadeIn = true;
		fade.alpha = 1.0;
		mainCamera.transform.position.x = targetPosition_level3_room3.position.x;
		...
		var teleportParlvl3r3 : GameObject = Instantiate(teleportParticle, this.gameObject.transform.position, Quaternion.Euler(0,0,0));
		teleportParlvl3r3.gameObject.transform.parent = this.gameObject.transform;
		teleportParlvl3r3.transform.position.y -= 10;
		shakeScript.Shake();
	}
	if(other.gameObject.tag == "Level3_room4"){
		...
		if(answerCount == 0){
			...
			for (var false_l3_r4_1 : GameObject in false_level3_room4){
		...
		if(answerCount == 1){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level3_room4"));
			for (var false_l3_r4_2 : GameObject in false_level3_room4){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level3_room4"));
			for (var false_l3_r4_3 : GameObject in false_level3_room4){
	...
	if(other.gameObject.tag == "false_level3_room4"){
		...
		fade.boolfadeIn = true;
		fade.alpha = 1.0;
		mainCamera.transform.position.x = targetPosition_level3_room4.position.x;
		...
		var teleportParlvl3r4 : GameObject = Instantiate(teleportParticle, this.gameObject.transform.position, Quaternion.Euler(0,0,0));
		teleportParlvl3r4.gameObject.transform.parent = this.gameObject.transform;
		teleportParlvl3r4.transform.position.y -= 10;
		shakeScript.Shake();
	}
	...
	if(other.gameObject.tag == "correct_level3_room5"){
		...
		if(answerCount == 0){
			...
			for (var false_l3_r5_1 : GameObject in false_level3_room5){
		...
		if(answerCount == 1){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level3_room5"));
			for (var false_l3_r5_2 : GameObject in false_level3_room5){
			...
			Destroy(other.gameObject);
			Destroy(GameObject.FindGameObjectWithTag("Level3_room5"));
			for (var false_l3_r5_3 : GameObject in false_level3_room5){
	...
	if(other.gameObject.tag == "false_level3_room5"){
		...
		fade.boolfadeIn = true;
		fade.alpha = 1.0;
		mainCamera.transform.position.x = targetPosition_level3_room5.position.x;
		...
		var teleportParlvl3r5 : GameObject = Instantiate(teleportParticle, this.gameObject.transform.position, Quaternion.Euler(0,0,0));
		teleportParlvl3r5.gameObject.transform.parent = this.gameObject.transform;
		teleportParlvl3r5.transform.position.y -= 10;
		shakeScript.Shake();
	}
}
